...
test('case-insensitive literal', () => {
  ...
  expect(matches).toEqual(new Uint32Array([0, 0, 5, 2, 0, 5]))
})
...
test('case-sensitive literal', () => {
  ...
  expect(matches).toEqual(new Uint32Array([0, 0, 5]))
})
...
test('whole word only', () => {
  ...
  expect(matches).toEqual(new Uint32Array([0, 0, 3, 1, 7, 3, 2, 4, 3]))
})
...
test('regex search', () => {
  ...
  expect(matches).toEqual(new Uint32Array([0, 0, 3, 1, 0, 3, 2, 3, 3]))
})
...
test('regex with case sensitive', () => {
  ...
  expect(matches).toEqual(new Uint32Array([1, 0, 3]))
})
...
test('regex with whole word', () => {
  ...
  expect(matches).toEqual(new Uint32Array([0, 0, 3, 1, 7, 3]))
})
