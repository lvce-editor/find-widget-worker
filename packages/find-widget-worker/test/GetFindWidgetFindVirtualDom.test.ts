...
test('getFindWidgetFindVirtualDom returns correct virtual dom elements with no matches', () => {
  ...
  expect(result).toEqual([
    ...
    },
    {
      ...
      name: 'MatchCase',
      onClick: DomEventListenerFunctions.HandleClickButton,
      onFocus: DomEventListenerFunctions.HandleFocusMatchCase,
      role: 'checkbox',
      tabIndex: 0,
      title: 'Match Case',
    ...
    },
    {
      ...
      name: 'MatchWholeWord',
      onClick: DomEventListenerFunctions.HandleClickButton,
      onFocus: DomEventListenerFunctions.HandleFocusMatchWholeWord,
      role: 'checkbox',
      tabIndex: 0,
      title: 'Match Whole Word',
      type: VirtualDomElements.Button,
    ...
    },
    {
      ...
      name: 'UseRegularExpression',
      onClick: DomEventListenerFunctions.HandleClickButton,
      onFocus: DomEventListenerFunctions.HandleFocusUseRegularExpression,
      role: 'checkbox',
      tabIndex: 0,
      title: 'Use Regular Expression',
      type: VirtualDomElements.Button,
