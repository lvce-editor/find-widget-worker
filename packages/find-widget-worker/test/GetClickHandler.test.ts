...
import * as FindWidgetFocusIndex from '../src/parts/FindWidgetFocusIndex/FindWidgetFocusIndex.ts'
...
test('getClickHandler - maps names to handlers', () => {
  ...
  expect(GetClickHandler.getClickHandler(InputName.FocusNext)).toBe(FindWidgetFocusIndex.focusNext)
  expect(GetClickHandler.getClickHandler(InputName.FocusPrevious)).toBe(FindWidgetFocusIndex.focusPrevious)
